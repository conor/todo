  ...
  return (
    <input
      ...
      className={cn(
        ...
        'aria-invalid:ring-rose-600/20 aria-invalid:border-rose-500 dark:aria-invalid:ring-rose-900/20 dark:dark:aria-invalid:ring-rose-900/40 dark:aria-invalid:border-rose-900',
        className,
      )}
      {...props}
    />
